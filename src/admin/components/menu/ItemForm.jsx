...
export function ItemForm({
  ...
  const [formData, setFormData] = useState({
    ...
    discount: {
      ...
      startDate: item?.discount?.startDate
        ? new Date(item.discount.startDate).toISOString().slice(0, 10)
        : "",
      endDate: item?.discount?.endDate
        ? new Date(item.discount.endDate).toISOString().slice(0, 10)
        : "",
    },
  ...
  const usedSizeIds = useMemo(
    () => new Set(formData.prices.map((p) => p.sizeId).filter(Boolean)),
    [formData.prices],
  );
  useEffect(
    () => () => {
  ...
  const handleSubmit = (e) => {
      ...
      discount: {
        ...
        value:
          formData.discount.value === ""
            ? 0
            : parseFloat(formData.discount.value),
    ...
    if (formData.nutritionalInfo) {
      const cleanNutritionalInfo = Object.fromEntries(
        Object.entries(formData.nutritionalInfo).filter(
          ([, value]) => value !== "",
        ),
      );
  ...
  const updatePriceRow = (index, field, value) => {
    setFormData((prev) => ({
      ...prev,
      prices: prev.prices.map((row, rowIndex) =>
        rowIndex === index
          ? {
              ...row,
              [field]: value,
      ...
      footer={
        <div className="flex items-center justify-end space-x-4">
          ...
          <button
            ...
            form="menu-item-form"
            disabled={isSaving}
            className="inline-flex items-center gap-2 px-6 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors disabled:opacity-60"
          >
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <select
                ...
                className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent ${errors.category ? "border-red-300" : "border-gray-300"}`}
              >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-3 py-2 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent ${errors.preparationTime ? "border-red-300" : "border-gray-300"}`}
                />
              </div>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  handleChange("spiceLevel", parseInt(e.target.value, 10))
                }
          ...
          <div className="mt-4">
            ...
            <textarea
              ...
              rows={3}
              className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent ${errors.description ? "border-red-300" : "border-gray-300"}`}
          ...
          <div className="mt-4">
            ...
            <textarea
              ...
              rows={2}
              className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent ${errors.ingredients ? "border-red-300" : "border-gray-300"}`}
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              type="button"
              onClick={addPriceRow}
              className="inline-flex items-center gap-2 text-sm px-3 py-1.5 border border-gray-300 rounded-lg hover:bg-gray-50"
            >
          ...
          <div className="space-y-3">
            {formData.prices.map((priceRow, index) => {
              const availableSizes = sizes.filter(
                (size) =>
                  !usedSizeIds.has(size._id) || size._id === priceRow.sizeId,
              );
              return (
                <div
                  key={`${priceRow.sizeId}-${index}`}
                  className="grid grid-cols-12 gap-3 items-start"
                >
                  <div className="col-span-12 md:col-span-5">
                    <select
                      value={priceRow.sizeId}
                      onChange={(e) =>
                        updatePriceRow(index, "sizeId", e.target.value)
                      }
                      className={`w-full px-3 py-2 border rounded-lg ${errors[`size-${index}`] ? "border-red-300" : "border-gray-300"}`}
                    >
                  ...
                  <div className="col-span-6 md:col-span-3">
                    <input
                      ...
                      className={`w-full px-3 py-2 border rounded-lg ${errors[`price-${index}`] ? "border-red-300" : "border-gray-300"}`}
                  ...
                  <div className="col-span-6 md:col-span-3">
                    <input
                      ...
                      min="0"
                      step="0.01"
                      value={priceRow.costPrice}
                      onChange={(e) =>
                        updatePriceRow(index, "costPrice", e.target.value)
                      }
                      className={`w-full px-3 py-2 border rounded-lg ${errors[`cost-${index}`] ? "border-red-300" : "border-gray-300"}`}
            ...
            <div className="flex-1 space-y-4">
              <div>
                ...
                <p className="mt-2 text-xs text-gray-500">
                  Upload a JPG or PNG image up to 2MB. Thumbnails are generated
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-4">
            <label className="flex items-center space-x-2">
              <input
                type="checkbox"
                checked={formData.seasonal.isSeasonal}
                onChange={(e) =>
                  handleSeasonalChange("isSeasonal", e.target.checked)
                }
            ...
            {formData.seasonal.isSeasonal ? (
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                <div>
                  ...
                  <input
                    type="text"
                    value={formData.seasonal.seasonName}
                    onChange={(e) =>
                      handleSeasonalChange("seasonName", e.target.value)
                    }
                ...
                <div>
                  ...
                  <input
                    type="date"
                    value={formData.seasonal.startDate}
                    onChange={(e) =>
                ...
                <div>
                  ...
                  <input
                    type="date"
                    value={formData.seasonal.endDate}
                    onChange={(e) =>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-300 px-3 py-2"
              placeholder="Optional promo label"
            />
          ...
          <textarea
            ...
            placeholder="Describe this discount for the admin team"
          />
        </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    onChange={(e) =>
                      handleChange("isVegetarian", e.target.checked)
                    }
                    className="rounded border-gray-300 text-primary-600 focus:ring-primary-500"
                  />
                  <label
                ...
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    onChange={(e) =>
                      handleChange("isGlutenFree", e.target.checked)
                    }
                    className="rounded border-gray-300 text-primary-600 focus:ring-primary-500"
                  />
                  <label
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleNutritionalInfoChange("calories", e.target.value)
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleNutritionalInfoChange("protein", e.target.value)
                    }
                    className="w-full px-2 py-1 border border-gray-300 rounded text-sm"
                    placeholder="g"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleNutritionalInfoChange("carbs", e.target.value)
                    }
                    className="w-full px-2 py-1 border border-gray-300 rounded text-sm"
                    placeholder="g"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleNutritionalInfoChange("fat", e.target.value)
                    }
                    className="w-full px-2 py-1 border border-gray-300 rounded text-sm"
                    placeholder="g"
                  />
