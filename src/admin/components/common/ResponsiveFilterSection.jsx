  ...
  return (
    ...
    >
      <button
        ...
        className="flex w-full items-center justify-between gap-3 rounded-lg border border-gray-200 bg-slate-50 px-4 py-3 text-left text-sm font-medium text-slate-700 md:hidden"
