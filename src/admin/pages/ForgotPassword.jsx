    ...
    description: "Staff can return to service without needing manual admin intervention."
        ...
        {success ? <div className="text-center space-y-6">
              ...
              <div>
                ...
                <p className="font-medium text-primary-600 text-lg mb-4">
                  {email}
                </p>
              </div>
              ...
              <div className="space-y-4 pt-4">
                ...
                <button onClick={handleTryAnotherEmail} className="w-full border border-primary-600 text-primary-600 hover:bg-primary-50 font-medium py-3 px-4 rounded-lg transition-colors">
                  Send to Another Email
                </button>

                <div className="text-sm text-gray-500 pt-2">
                  Didn't receive the email? Check your spam folder or{" "}
                  <button onClick={handleTryAnotherEmail} className="text-primary-600 hover:text-primary-800 font-medium">
            ...
            setError("");
              ...
              <button type="submit" disabled={isLoading} className="w-full bg-primary-600 hover:bg-primary-700 disabled:bg-gray-400 text-white font-semibold py-3 px-4 rounded-lg transition-colors flex items-center justify-center">
                {isLoading ? <>
              ...
              <div className="text-center">
                <Link to={buildAdminPath("/login")} className="text-sm text-primary-600 hover:text-primary-800 font-medium">
                  Remember your password? Sign in
                </Link>
              </div>
            </form>}
        {!success && <div className="text-center mt-6 text-sm text-gray-500">
