...
const QR_SIZE_OPTIONS = [
  ...
  { value: "medium", label: "Medium (250x250)" },
  { value: "large", label: "Large (350x350)" },
...
const PRINT_LAYOUT_OPTIONS = [
  ...
  { value: "table-tent", label: "Table Tent Style" },
        ...
        <div className="mt-4 grid grid-cols-2 gap-2">
          {[
            ...
            return (
              <button
                key={tab.id}
                className={`inline-flex items-center justify-center gap-2 rounded-2xl px-4 py-2.5 text-sm font-medium transition ${
                  activeTab === tab.id
              ...
              <div className="mt-4 flex min-h-[300px] items-center justify-center rounded-[1.5rem] border-2 border-dashed border-slate-200 bg-white p-4">
                {tableState.qrCode ? (
                  <img
                    ...
                    style={{ width: getQrPreviewWidth(qrSize) }}
                  />
                ) : (
            ...
            <section className="space-y-4">
              <div className="rounded-[1.5rem] border border-slate-200 bg-white p-4 sm:p-5">
                ...
                <div className="mt-4 space-y-3">
                  {[
                    { label: "Table Number", value: table.number },
