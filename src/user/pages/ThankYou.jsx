...
export function ThankYou() {
  ...
  const message = location.state?.message || "Thank you for dining with us. We hope to see you again soon.";
  return <div className="flex min-h-screen items-center justify-center bg-[radial-gradient(circle_at_top,_#ecfeff,_#f8fafc_55%,_#ffffff)] px-4 py-10">
      <div className="w-full max-w-xl rounded-[2rem] border border-emerald-100 bg-white/95 p-8 text-center shadow-[0_24px_80px_rgba(15,23,42,0.08)] backdrop-blur">
        ...
        <div className="mt-8 grid gap-3 sm:grid-cols-2">
          <button type="button" onClick={() => navigate(buildCustomerPath("/"), {
          replace: true
