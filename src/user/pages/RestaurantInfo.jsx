...
export function RestaurantInfo() {
  ...
  const enabledPaymentMethods = [
    ...
    paymentMethods.splitBill ? "Split bill available" : null,
  ].filter(Boolean);
  const handleBack = () => {
  ...
  const restaurantInfo = {
    ...
    description:
      settings?.restaurant?.description || t("restaurantDescription"),
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto p-4 space-y-6">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          <div className="h-48 bg-linear-to-r from-primary-500 to-primary-600 flex items-center justify-center">
          ...
          <div className="p-6">
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2">
              ...
              <div className="rounded-lg bg-primary-50 p-4">
                ...
                <p className="mt-1 font-semibold text-gray-900">
                  Tax {restaurantInfo.taxRate}% • Service{" "}
