...
import { Clock, CheckCircle2, ChefHat, Utensils, Truck, ArrowLeft, RefreshCw } from "lucide-react";
    ...
    return <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="bg-white border border-gray-200 rounded-2xl p-6 text-center max-w-md w-full">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Start ordering from the menu and your live order updates will appear here.
          </p>
          <button onClick={() => navigate(buildCustomerPath("/home/menu"))} className="cursor-pointer bg-primary-600 hover:bg-primary-700 text-white rounded-lg px-4 py-2">
            Browse Menu
          </button>
        </div>
      </div>;
  ...
  return <div className="min-h-screen bg-gray-50 mb-14">
      ...
      <div className="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-50">
        <div className="max-w-2xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <button onClick={handleRefresh} disabled={isRefreshing} className="cursor-pointer p-2 text-gray-600 hover:text-primary-600 disabled:opacity-50">
      ...
      <div className="max-w-2xl mx-auto p-4 space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex justify-between items-start mb-4">
            <div>
              ...
              <p className="mt-1 text-sm capitalize text-gray-500">
                Payment: {String(order?.paymentStatus || "pending").replace(/_/g, " ")}
              </p>
            </div>
          ...
          {order.specialInstructions && <div className="border-t border-gray-200 pt-4 mt-4">
        ...
        <div className="bg-orange-50 rounded-lg border border-orange-200 p-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button onClick={() => handleQuickCall("menu_help")} disabled={isCalling} className="bg-white hover:bg-gray-50 disabled:bg-gray-200 text-orange-600 border border-orange-600 px-4 py-2 rounded-lg text-sm font-medium transition-colors flex-1">
        ...
        {order.status === ORDER_STATUS.SERVED && <div className="bg-green-50  rounded-lg border border-green-200 p-6 text-center">
            ...
            <button onClick={handleRequestBill} className="bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-lg font-medium transition-colors">
              Request Bill
            </button>
          </div>}
      </div>
