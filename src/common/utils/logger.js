...
const readEnvironment = () => {
  ...
  return {
    mode: viteEnv?.MODE || (typeof process !== "undefined" ? process.env?.NODE_ENV : undefined) || "development",
    configuredLevel: viteEnv?.VITE_LOG_LEVEL || (typeof process !== "undefined" ? process.env?.VITE_LOG_LEVEL : undefined) || ""
  };
};
...
const writeLog = (level, message, ...meta) => {
  ...
  const args = [`[${timestamp}] [${level.toUpperCase()}]`, message, ...meta.map(safeSerialize)];
